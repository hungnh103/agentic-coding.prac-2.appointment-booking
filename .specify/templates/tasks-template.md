...
**Tests**: Include the test tasks required to satisfy the constitution and
feature plan. Omit a test layer only when the plan explicitly documents why it
adds no value and what validation replaces it.
...
- [ ] T004 [P] Define performance measurement approach and baseline capture for
...
- [ ] T013 [P] [US1] Unit test for [domain behavior] in tests/unit/test_[name].py
...
- [ ] T020 [US1] Validate performance budget for the story
...
- [ ] T023 [P] [US2] Unit test for [domain behavior] in tests/unit/test_[name].py
...
- [ ] T028 [US2] Validate UX states and copy consistency for the story
- [ ] T029 [US2] Validate performance budget for the story
...
- [ ] T032 [P] [US3] Unit test for [domain behavior] in tests/unit/test_[name].py
...
- [ ] T037 [US3] Validate performance budget for the story
...
- [ ] TXXX [P] Accessibility and UX consistency review across changed flows
...
- UX consistency and performance validation before story sign-off
